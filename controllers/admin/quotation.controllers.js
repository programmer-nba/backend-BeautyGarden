  ...
  try {
    ...
    const quotation = await new Quotation({
      ...
      customer_detail: {
        ...
        customer_contact_sign: customer.customer_contact_sign,
      },
      isSign: isSign,
      product_detail: updatedProductDetail,
    ...
    const updatedQuotation = await Quotation.findOneAndUpdate(
      { _id: customer_number },
      {
        ...
        : null,
          ...
          "customer_detail.customer_contact": customer_detail.customer_contact || null,
          "customer_detail.customer_contact_number": customer_detail.customer_contact_number || null,
          "customer_detail.customer_contact_sign": customer_detail.customer_contact_sign || null,
